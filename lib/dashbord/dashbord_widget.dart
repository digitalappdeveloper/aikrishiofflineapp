...
///
/// At the top, show a "Weather Card" with temperature, rain chance, and
/// location. Below, create a 2x2 Grid of large, colorful Card buttons with
/// big icons. Labels in Hindi & English: 1. "Crop Disease (Fasal Rog)", 2.
...
class _DashbordWidgetState extends State<DashbordWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.apiResulttuf = await WeatherAPICall.call(
        city: currentUserLocationValue?.toString(),
      );

      if ((_model.apiResulttuf?.succeeded ?? true)) {
        _model.weatherData = (_model.apiResulttuf?.jsonBody ?? '');
